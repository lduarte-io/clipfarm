...
**Test counts:** **228 green** (`swift test`, ~4 s): 156 baseline + 72 new — CFDomain 78 (was 51: +25 segmentation/tail/text + 2 golden masters), CFStore 91 (was 58: +2 migration/round-trip, +20 ingest, +8 re-apply, +2 update-source, +1 FTS-at-ingest via ingest), CFMedia 46 (was 40: +2 probe-adapter, +4 waveform incl. the real-material perf leg), CFExport 7 (was 1: +6 locator/remux), CFLLM 6 (unchanged). Golden masters and real-material legs skip visibly on machines without ffmpeg or the inbox.
