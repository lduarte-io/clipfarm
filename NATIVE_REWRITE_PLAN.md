...
**Verify:** ingest `05.19.26/` — counts match the web version modulo tail policy; clips no longer feel cut short; flip tail policy, re-apply on one source, hear the difference, undo it.
